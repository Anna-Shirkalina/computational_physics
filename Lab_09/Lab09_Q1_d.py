...
pickle.dump(Psi_n, open("./Psi_n_d.pickle", "wb"))
pickle.dump(Energy, open("./Energy_d.pickle", "wb"))
pickle.dump(Psi_norm, open("./Psi_norm_d.pickle", "wb"))
